      ...
      <div className="col-span-12 lg:col-span-4">
        <form onSubmit={handleSubmit((data) => handleSubmitEditBrand(data, id))}>
          <div className="mb-6 bg-white px-8 py-8 rounded-md">
            ...
            {/* Form Field */}
            <BrandFormField default_val={brand.name} register={register} errors={errors} name="Name" label="Tên" isReq={true} />
            <BrandFormField default_val={brand.email} register={register} errors={errors} name="Email" label="Email" isReq={true} />
            <BrandFormField default_val={brand.website} register={register} errors={errors} name="Website" label="Trang web" isReq={false} />
            <BrandFormField default_val={brand.location} register={register} errors={errors} name="Location" label="Vị trí" isReq={false} />
            {/* Form Field */}
